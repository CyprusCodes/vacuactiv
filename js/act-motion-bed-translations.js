...
$.i18n.gr = {
  ...
  msx: "Ενδυναμώνει τους μύες, βελτιώνει<br> την κινητικότητα και την ευελιξία των αρθρώσεων",
  msx_i:
    "<strong>Οι ασκήσεις στα τονωτικά κρεβάτια Activ Motion ενδυναμώνουν αυτούς τους μύες και βελτιώνουν την κινητικότητα και την ευελιξία των αρθρώσεων.</strong> Προσφέρονται επίσης σε άτομα που πάσχουν από οστεοπόρωση, γυναίκες μετά τον τοκετό, άτομα με άσθμα και προβλήματα καρδιαγγειακού συστήματος. Τα κρεβάτια Activ Motion δεν επιταχύνουν τη λειτουργία της καρδιακής μυικής μάζας, δεν προκαλούν δύσπνοια ή αυξάνουν την πίεση. Βοηθούν ατομα με προβλήματα υγρασίας. Επιπλέον, έχουν θεραπευτική σημασία, καθώς διεγείρουν την κυκλοφορία του αίματος. Οι ασθενείς αισθάνονται χαλαρωμένοι και αναζωογονημένοι μετά από κάθε κύκλο ασκήσεων. Οι πόνοι στις αρθρώσεις και τη σπονδυλική στήλη εξαφανίζονται.",
  msb: "Οφέλη της άσκησης στα<br> κρεβάτια:",
  msb_i:
    "<li><sup>1</sup> ρύθμιση του μυϊκού τόνου</li> <li><sup>2</sup> ενδυνάμωση της μυϊκής δύναμης</li> <li><sup>3</sup> βελτίωση της κινητικότητας αρθρώσεων</li> <li><sup>4</sup> βελτίωση της κυκλοφορίας και της παροχής αίματος σε ολόκληρο το σώμα</li> <li><sup>5</sup> μείωση της λιπώδους ιστού, απώλεια βάρους</li> <li><sup>6</sup> βελτίωση του μεταβολισμού</li> <li><sup>7</sup> μείωση της κυτταρίτιδας</li>",
  msd: "Παθήσεις για τις οποίες μπορεί να χρησιμοποιηθεί το σύστημα κρεβατιών:",
  msd_i:
    "<li><sup>1</sup> εκφυλιστική νόσος της σπονδυλικής στήλης</li> <li><sup>2</sup> δισκοπάθειες</li> <li><sup>3</sup> υπερφόρτωση αρθρώσεων, συστήματος κυκλοφορίας</li> <li><sup>4</sup> οστεοπόρωση</li> <li><sup>5</sup> αρθροπάθεια της ισχίου και του γόνατος</li> <li><sup>6</sup> συνέπειες τραυματισμών κάτω άκρων</li> <li><sup>7</sup> συνέπειες τραυματισμών της σπονδυλικής στήλης και του νωτιαίου μυελού</li> <li><sup>8</sup> ρευματοειδής αρθρίτιδα</li>",
  msd_ii:
    "<li><sup>9</sup> ρύθμιση του μυϊκού τόνου</li> <li><sup>10</sup> ενδυνάμωση της μυϊκής δύναμης</li> <li><sup>11</sup> βελτίωση της κινητικότητας αρθρώσεων</li> <li><sup>12</sup> βελτίωση της κυκλοφορίας και της παροχής αίματος σε ολόκληρο το σώμα</li> <li><sup>13</sup> μείωση της λιπώδους ιστού, απώλεια βάρους</li> <li><sup>14</sup> βελτίωση του μεταβολισμού</li> <li><sup>15</sup> μείωση της κυτταρίτιδας</li>",
  msd_iii:
    "<li><sup>16</sup> εκφυλιστική νόσος της σπονδυλικής στήλης</li> <li><sup>17</sup> δισκοπάθειες</li> <li><sup>18</sup> υπερφόρτωση αρθρώσεων, συστήματος κυκλοφορίας</li> <li><sup>19</sup> οστεοπόρωση</li> <li><sup>20</sup> αρθροπάθεια της ισχίου και του γόνατος</li> <li><sup>21</sup> συνέπειες τραυματισμών κάτω άκρων</li> <li><sup>22</sup> συνέπειες τραυματισμών της σπονδυλικής στήλης και του νωτιαίου μυελού</li> <li><sup>23</sup> ρευματοειδής αρθρίτιδα</li>",
  mst: "Το σετ Activ Motion Bed<br> αποτελείται από:",
  mst_c: "01",
  mt_st: "Τραπέζι για σακούλες άμμου",
  mst_ci: "Διαμόρφωση της σιλουέτας των μηρών και γλουτών",
  mst_m: "10",
  mst_mi: "Λεπτά",
  mst_n: "1000",
  mst_ni: "κινήσεις",
  ...
  ss_hi: "69<sup>εκ</sup>",
  ss_w: "Πλάτος",
  ss_wi: "85,1<sup>εκ</sup>",
  ss_l: "Μήκος",
  ss_li: "201,2<sup>εκ</sup>",
  ssw: "Βάρος",
  ssw_i: "145<sup>κγ</sup>",
  ss_i: "<strong>Η Μηχανή με Σακούλες Άμμου χρησιμοποιεί δύο μαξιλάρια που κινούνται πίσω και μπροστά πάνω από τους γλουτούς για να σφίξει και να τονώσει, και ταυτόχρονα να ενισχύσει τους κοιλιακούς μύες.</strong> Καθώς εξασκείται οι γλουτοί, η κυτταρίτιδα διαλύεται και διαλύεται. (Η κυτταρίτιδα είναι λίπος και νερό που παγιδεύονται κάτω από το δέρμα και οδηγούν σε ανώμαλη υφή δέρματος.) Η απαλή ρυθμική κίνηση της μηχανής διαλύει την κυτταρίτιδα, δίνοντας στο δέρμα σφίξιμο και ομαλή υφή. Η σακούλα με την άμμο ασκεί πίεση στην κοιλιά, βοηθώντας τη μηχανή να λειτουργεί πιο αποτελεσματικά στους γλουτούς.",
  ss_ii:
    "Με αντίσταση τάσης, εργαζόμαστε στους μύες των γλουτών και τους ίσιους κοιλιακούς. Ελαφριές, ρυθμικές κινήσεις μασάζ βοηθούν στην χαλάρωση και την ενδυνάμωση των μυών γύρω από την οσφυϊκή σπονδύλη, καίγοντας λίπος στους μηρούς, τους γλουτούς και τους μηρούς.",
  lgt_i: "02",
  lgt: "Τραπέζι Ποδιών",
  shl: "Διαμόρφωση της σιλουέτας των ποδιών",
  sw_i: "3<sup>χλμ</sup>",
  sw_ii: "πεζοπορία",
  sh_ii: "100,4<sup>εκ</sup>",
  se_ii: "85,1<sup>εκ</sup>",
  sl_ii: "202,7<sup>εκ</sup>",
  sp_i: "<strong>Η Μηχανή Ποδιών επιτρέπει την συγκέντρωση σε συγκεκριμένες περιοχές των ποδιών. Υπάρχουν τρεις ξεχωριστές αλλά συνεχείς κινήσεις τραβήγματος που εμπλέκονται.</strong>",
  sp_ii:
    " - Τα πόδια κινούνται προς τα μέσα χρησιμοποιώντας τους μύες των εσωτερικών μηρών. <br /> - Τα πόδια κινούνται προς το σώμα χρησιμοποιώντας όλους τους μύες των μηρών. <br /> - Τα πόδια κινούνται προς τα έξω και μακριά χρησιμοποιώντας τους μύες των εξωτερικών μηρών.",
  sp_iii:
    "Τα γόνατα διατηρούνται ελαφρώς κάμπτοντα. Δεν περιλαμβάνονται κινήσεις πιέσεως ή αντίστασης. Αυτή η μηχανή μειώνει τα ίντσες, σφίγγει και τονώνει την περιοχή ολόκληρου του ποδιού ενώ επικεντρώνεται στη μείωση των εσωτερικών μηρών, την περιοχή των γονάτων και των πλευρικών μετώπων στους εξωτερικούς μηρούς.",
  sp_iiii:
    "Ασκήσεις για μίμηση πεζοπορίας. Εκτελώντας κυκλικές κινήσεις, ασκούνται οι μύες της προσθαίας και της αποσθαίας μηρών, καθώς και οι τρίτοι τραχήλιοι και τετραχήλιοι μύες του μηρού. Οι αρθρώσεις του ισχίου και των γονάτων ενισχύονται και ξεκλειδώνονται. Οι ασκήσεις σε αυτό το κρεβάτι λεπταίνουν τα πόδια, ιδιαίτερα την εσωτερική και την εξωτερική πλευρά των μηρών, ρυθμίζουν την κυκλοφορία του αίματος στα κάτω άκρα, διεγείρουν την κυκλοφορία στην κοιλιακή περιοχή, με θετικό αντίκτυπο στον κύκλο της εμμηνόπαυσης και το ουροποιητικό σύστημα. Αυτού του είδους οι κινήσεις χρησιμοποιούνται στο φιτνες.",
  stt_n: "03",
  stt_t: "Τραπέζι Ανύψωσης Σώματος",
  stt_p: "Διαμόρφωση της σιλουέτας της κοιλιάς, μηρών και μηριαίων.",
  stt_s: "90",
  stt_si: "κοιλιακές ανύψωσεις",
  stt_li: "191,2<sup>εκ</sup>",
  stt_i:
    "<strong>Οι ασκήσεις πραγματοποιούνται με βάση την αρχή «καθίστε και αναπαυθείτε».</strong> Οι μύες της μέσης και της κοιλιάς εντελώς και χαλαρώνουν κατά τη διάρκεια αυτής της άσκησης. Οι κύριοι μύες που εμπλέκονται είναι οι εξωτερικοί κοιλιακοί μύες, οι εσωτερικοί κοιλιακοί μύες και οι διεγερτικοί κοιλιακοί μύες. Χάρη σε αυτό, το λιπώδες ιστό παίρνει φωτιά κυρίως στην περιοχή τους. Ενισχύεται επίσης η κάτω πλάτη.",
  swh: "04",
  swh_t: "Τραπέζι Λεπτής Μέσης, Κοιλιάς, Ισχίων",
  swh_p: "Διαμόρφωση της σιλουέτας της κάτω πλάτης, των γλουτών και των μηρών.",
  swh_l: "900",
  swh_li: "κινήσεις ποδιών",
  swh_i:
    "<strong>Η Μηχανή Λεπτής Μέσης, Κοιλιάς, Ισχίων ανεβαίνει και κατεβαίνει τα πόδια 650 φορές κατά τη διάρκεια μιας κανονικής 10-λεπτης αγωγής.</strong> Κατά τη διάρκεια αυτής της κίνησης, η μέση περιστρέφεται απαλά. Η ταυτόχρονη δράση σφίγγει, δονεί και μειώνει τη μέση, την κοιλιά και τα ισχία. Αυτή η μηχανή συνδυάζει την περιστροφική κίνηση της μέσης με την ανύψωση των ποδιών. Αυτή η κίνηση γρήγορα απομακρύνει ίντσες από τη μέση, την κοιλιά και τα ισχία, ενώ ενισχύει τους μύες στην κάτω πλάτη. Το αποτέλεσμα είναι σφιχτά γλουτούς, πιο δυνατά πόδια και μεγαλύτερη ευελιξία.",
  swh_ii:
    "Ο άσκησης ανυψώνει και καταβάλλει τα πόδια ελαφρά και ρυθμικά. Καίει το λίπος γύρω από τη μέση, μειώνει την περίμετρο της μέσης και των ισχίων, μειώνει το κυτταρίτιδα και σφίγγει τους γλουτούς. Ενισχύεται η κάτω πλάτη.",
  sbl: "05",
  sblli: "Τραπέζι Επιμήκυνσης",
  sbl_i:
    "<strong>Η Μηχανή Επιμήκυνσης διαθέτει μια επάνω επιφάνεια που κινείται προς τα πάνω και προς τα κάτω. Ο ασθενής βρίσκεται επίπεδος με τους αστραγάλους στον κινούμενο πάγκο.</strong> Τα άνω άκρα εκτείνονται με τα χέρια να χτυπούν το μπάρο που βρίσκεται στο κεφάλι της μηχανής, καθώς η πλάτη μετακινείται. Αυξάνεται η επέκταση της άνω πλάτης. Προσφέρει επιπλέον οφέλη στην αύξηση της κινητικότητας της κοιλιάς, του κορμού και του αυχένα.",
  sbl_ii:
    "Το κρεβάτι κάνει μασάζ στο άνω μέρος του σώματος, συμπεριλαμβανομένης της αυχενικής σπονδυλικής στήλης, του μασχαλισμού της μέσης και των ωμοπλάτων, προκαλώντας, μεταξύ άλλων, την χαλάρωσή τους. Έχει πολύ θετική επίδραση στο σχήμα των γοφών και της μέσης. Ενισχύει και διαμορφώνει το στήθος, βελτιώνει τη σφριγηλότητα του στήθους, ενισχύει τους κοιλιακούς μύες και σφίγγει τους βραχίονες. Οι ασκήσεις με αυτό το κρεβάτι εμποδίζουν την άσχημη καταπόνηση των ώμων, ενισχύοντας τους μύες της κοιλιοκοιλιακής, της πλάτης και του στήθους. Επίσης, αποτρέπουν τους πόνους στην πλάτη που προκαλούνται από μονοπλευρή φόρτιση.",
  sbr: "06",
  sbri: "Τραπέζι Χαλάρωσης",
  sbrp: "Ευχάριστη χαλάρωση, βελτίωση της κυκλοφορίας του αίματος",
  sbr_i:
    "<strong>Η Μηχανή Κραδασμών δημιουργεί μια δονούμενη κίνηση που μασάζιει απαλά ολόκληρο το σώμα.</strong> Οι κύριες λειτουργίες είναι να βοηθά στην αύξηση της κυκλοφορίας του αίματος, να απαλλάσσει το σώμα από το υπερβολικό νερό και να βοηθά να διαλύει την κυτταρίτιδα. Η κίνηση της μηχανής είναι απαλή και χαλαρωτική και δημιουργεί μια ενεργητική και φρέσκια αίσθηση.",
  sbr_ii:
    "Οι ασκήσεις πάνω σε αυτό συνιστώνται, μεταξύ άλλων, σε ρευματοειδή αρθρίτιδα, διαβήτη, υπέρταση ή υπόταση, υπέρβαρο, εκφυλιστικές νόσους της σπονδυλικής στήλης, οστεοπόρωση, επιπλοκές μετά από νοσήματα του ουροποιητικού συστήματος, κακώσεις της σπονδυλικής στήλης και του νωτιαίου μυελού, δισκοπάθειες, εκφυλιστικές νόσους των ισχίων και των γόνατων, πολλαπλή σκλήρυνση και άλλες νοσήματα του μυοσκελετικού συστήματος. Έχουν επίσης προφυλακτική και προληπτική επίδραση.",
