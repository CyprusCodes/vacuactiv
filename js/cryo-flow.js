...
$.i18n.en = {
  ...
  included_tips: "Included tips",
  small_range_treatment:
    "Small range treatment, reduces skin temperature, such as eyebrows, armpits, foreheads.",
  middle_square_adapter: "Middle square adapter",
  moderate_range_of_treatment:
    "Moderate range of treatment to reduce skin temperature, especially hair removal treatment, such as arms,armpits, legs.",
  large_square_adapter: "Large square adapter",
  large_square_adapter_info:
    "Large-scale treatment reduces skin temperature, especially hair removal treatment, such asthighs and abdomen.",
  compatible: "Compatible",
  laser_hair_removal: "808 laser (for laser hair removal treatment)",
  shr_rejuvenation: "SHR (hair rejuvenation treatment)",
  ipl_laser: "IPL – 980 laser",
  co2_laser: "CO2 laser",
  rf_machine: "RF machine",
  benefits: "Benefits",
  help_to_reduce_muscle_pain: "Help to <br/> reduce muscle pain",
  protects_tissues: "Protects the<br/> tissues &amp; skin after sport injuries",
  minimize_inflammations:
    "Minimize possible <br/> inflammations and/or the risk of swelling after treatment",
  helps_prevent_skin_infection: "Helps to<br/> prevent skin infection",
  tech_specs: "Specifications",
  size: "Size",
  height: "Height",
  height_in_size: "83,9cm (33,03 inches)",
  height_with_supporter: "Height with supporter",
  height_with_supporter_in_size: "203,5 cm (80,12 inches)",
  width: "Width",
  width_in_size: "57,4 cm (22,6 inches)",
  depth: "Depth",
  depth_in_size: " 88,1 cm (34,69 inches)",
  type: "Type",
  air_cooling_system: "Air cooling system",
  power_supply: "Power supply",
  power_supply_level: "220VAC / 50Hz / 3A<br />110VAC / 60Hz / 3A",
  weight: "Weight",
  weight_kg: "62 kg",
  power_consumption: "Power consumption",
  power_in_watt: "1500W",
  touch_display_size: "Touch display size",
  size_in_inch: "10.1-inch",
  temp_range: "Temperature range",
  temp_degree: "-30°C to -4°C",
  fans_power_levels: "Fans power levels",
...
$.i18n.ru = {
  ...
  included_tips: "Включенные советы",
  small_range_treatment:
    "Обработка небольшой площади, снижает температуру кожи, такую как брови, подмышечные впадины, лоб.",
  middle_square_adapter: "Адаптер среднего квадрата",
  moderate_range_of_treatment:
    "Умеренный спектр процедур для снижения температуры кожи, особенно процедуры по удалению волос, такие как на руках, подмышках, ногах.",
  large_square_adapter: "Большой квадратный адаптер",
  large_square_adapter_info:
    "Масштабное лечение снижает температуру кожи, особенно лечение удаления волос, такое как на бедрах и животе.",
  compatible: "совместимый",
  laser_hair_removal: "808 лазер (для процедуры лазерного удаления волос)",
  shr_rejuvenation: "SHR (терапия восстановления волос)",
  ipl_laser: "Лазер IPL – 980",
  co2_laser: "CO2 лазер",
  rf_machine: "РЧ-машина",
  benefits: "Преимущества",
  help_to_reduce_muscle_pain: "Помогает снизить боль в мышцах",
  protects_tissues: "Защищает ткани и кожу после травм во время спорта",
  minimize_inflammations:
    "Минимизировать возможное <br/> воспаления и/или риск отёка после лечения",
  helps_prevent_skin_infection: "Помогает предотвратить инфекции кожи",
  tech_specs: "характеристики",
  size: "Размер",
  height: "Высота",
  height_in_size: "83,9 см (33,03 дюйма)",
  height_with_supporter: "Высота с поддержкой",
  height_with_supporter_in_size: "203,5 см (80,12 дюйма)",
  width: "Ширина",
  width_in_size: "57,4 см (22,6 дюйма)",
  depth: "Глубина",
  depth_in_size: "88,1 см (34,69 дюйма)",
  type: "Тип",
  air_cooling_system: "Система воздушного охлаждения",
  power_supply: "Источник питания",
  power_supply_level: "220VAC / 50Hz / 3A<br />110VAC / 60Hz / 3A",
  weight: "Вес",
  weight_kg: "62 кг",
  power_consumption: "Потребляемая мощность",
  power_in_watt: "1500 Вт",
  touch_display_size: "Размер сенсорного дисплея",
  size_in_inch: "10.1 дюйма",
  temp_range: "Диапазон температур",
  temp_degree: "-30°C до -4°C",
  fans_power_levels: "Уровни мощности вентиляторов",
  cooling_tube_length: "Длина охладительной трубки",
...
$.i18n.gr = {
  ...
  included_tips: "Περιλαμβανόμενες συμβουλές",
  small_range_treatment:
    "Μικρής εμβέλειας θεραπεία, μειώνει τη θερμοκρασία του δέρματος, όπως φρύδια, μασχάλες, μέτωπο.",
  middle_square_adapter: "Μεσαίο τετράγωνο αντάπτορας",
  moderate_range_of_treatment:
    "Μέτρια εύρος θεραπείας για μείωση της θερμοκρασίας του δέρματος, ιδιαίτερα θεραπεία για αφαίρεση τριχών, όπως στα χέρια, στα μασχάλα, στα πόδια.",
  large_square_adapter: "Μεγάλο τετράγωνο αντάπτορας",
  large_square_adapter_info:
    "Η μεγάλης κλίμακας αγωγή μειώνει τη θερμοκρασία του δέρματος, ειδικά η αγωγή αφαίρεσης τριχών, όπως στους μηρούς και την κοιλιά",
  compatible: "συμβατός",
  laser_hair_removal: "808 λέιζερ (για θεραπεία αποτρίχωσης με λέιζερ",
  shr_rejuvenation: " SHR (θεραπεία αναζωογόνησης μαλλιών)",
  ipl_laser: "Λέιζερ IPL – 980",
  co2_laser: "CO2 λέιζερ",
  rf_machine: "RF μηχανή",
  benefits: "Οφέλη",
  help_to_reduce_muscle_pain: "Βοηθά στη μείωση του πόνου των μυών",
  protects_tissues:
    "Προστατεύει τα ιστούς και το δέρμα μετά από τραυματισμούς από άθληση",
  minimize_inflammations:
    "Ελαχιστοποιήστε το δυνατόν <br/> φλεγμονές και/ή κίνδυνος οίδηματος μετά από αγωγή",
  helps_prevent_skin_infection: "Βοηθά στην πρόληψη μολύνσεων του δέρματος",
  tech_specs: "Προδιαγραφές",
  size: "Μέγεθος",
  height: "Ύψος",
  height_in_size: "83,9 εκ. (33,03 ίντσες)",
  height_with_supporter: "Ύψος με υποστηρικτή",
  height_with_supporter_in_size: "203,5 εκ. (80,12 ίντσες)",
  width: "Πλάτος",
  width_in_size: "57,4 εκ. (22,6 ίντσες)",
  depth: "Βάθος",
  depth_in_size: "88,1 εκ. (34,69 ίντσες)",
  type: "Τύπος",
  air_cooling_system: "Σύστημα ψύξης αέρα",
  ...
  power_in_watt: "1500W",
  touch_display_size: "Μέγεθος αφής οθόνης",
  size_in_inch: "10.1 ίντσες",
  temp_range: "Εύρος θερμοκρασίας",
  temp_degree: "-30°C έως -4°C",
  fans_power_levels: "Επίπεδα ισχύος ανεμιστήρων",
  cooling_tube_length: "Μήκος σωλήνα ψύξης",
